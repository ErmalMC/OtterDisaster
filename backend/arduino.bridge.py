...
class SensorBridge:
    ...
    def parse_arduino_line(self, line: str) -> dict | None:
        ...
        Expected format: "TDS:342.5,PH:7.23"
        """
        try:
            ...
            log.debug(f"Could not parse: {line!r} ({e})")
            return None
    ...
    def predict(self, observation: dict) -> dict:
        ...
        from train import classify_anomaly_type, build_explanation, severity_level, ANOMALY_TYPES
